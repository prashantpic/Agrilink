...
// Command object for updating a FarmLandRecord
@Value // Immutable
@Builder // Builder pattern for easy construction
public class UpdateFarmLandRecordCommand { // REQ-2-001

    // Nullable fields indicate optional updates
    ...
    LeaseDetailsCommand leaseDetails; // REQ-2-009 (Can be null to remove or update)
    List<SoilTestHistoryEntryCommand> soilTestHistory; // REQ-2-012

    @Value // Immutable
    @Builder
    public static class OwnershipDocumentCommand { // REQ-2-008
        UUID id; // Include ID for updates/deletes
