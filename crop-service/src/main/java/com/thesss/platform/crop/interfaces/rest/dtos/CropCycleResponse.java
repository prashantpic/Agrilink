...
public class CropCycleResponse {
    ...
    private String yieldPerUnitArea;
    private String notes;
    private List<FarmingActivityResponse> activities;
    private List<MarketSaleResponse> marketSales;
    ...
    public UUID getCropCycleBusinessId() {
        return cropCycleBusinessId;
    }

    public void setCropCycleBusinessId(UUID cropCycleBusinessId) {
        this.cropCycleBusinessId = cropCycleBusinessId;
    }
    ...
    public void setLandRecordId(UUID landRecordId) {
    ...
    public String getYieldPerUnitArea() {
        return yieldPerUnitArea;
    }

    public void setYieldPerUnitArea(String yieldPerUnitArea) {
        this.yieldPerUnitArea = yieldPerUnitArea;
    }
    ...
    public List<FarmingActivityResponse> getActivities() {
        return activities;
    }

    public void setActivities(List<FarmingActivityResponse> activities) {
        this.activities = activities;
    }

    public List<MarketSaleResponse> getMarketSales() {
        return marketSales;
    }

    public void setMarketSales(List<MarketSaleResponse> marketSales) {
    ...
    public void setRecordCreationDate(Instant recordCreationDate) {
